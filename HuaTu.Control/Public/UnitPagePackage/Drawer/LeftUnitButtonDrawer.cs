...
{
    class LeftUnitButtonDrawer : UnitButtonDrawer
    {
        ...
        public override void Draw(Rectangle bounds, string text, bool selected, Font font, Icon icon, Graphics graphics)
        {
            using (GraphicsPath button = new GraphicsPath())
            {
                ...
                bounds.Width++;
                using (LinearGradientBrush backBrush = new LinearGradientBrush(bounds, GetBackGradient1Color(selected),
                    GetBackGradient2Color(selected), BackGradientMode))
                {
            ...
            if (icon != null)
            {
                graphics.DrawIcon(icon,
                    new Rectangle(bounds.X + 2, textBounds.Y + 2, ButtonWidth - 4, ButtonWidth - 4));
        ...
        public override void DrawButtonsLine(Graphics graphics, Rectangle panelBounds, Rectangle buttonsPanelBounds)
        {
            ...
            {
                graphics.DrawLine(pen, buttonsPanelBounds.Right, panelBounds.Top, buttonsPanelBounds.Right,
                    panelBounds.Bottom);
            }
        }
        ...
        {
            return new Rectangle(panelBounds.Left, panelBounds.Top - ButtonWidth, ButtonWidth - ButtonLeftMargin,
                ButtonWidth - ButtonLeftMargin);
        }
        ...
        {
            return new Rectangle(panelBounds.Left, panelBounds.Bottom + 4, ButtonWidth - ButtonLeftMargin,
                ButtonWidth - ButtonLeftMargin);
        }
        ...
        public override Rectangle GetFirstButtonBounds(Rectangle panelBounds, bool hasScroll, int scrolPos, string text,
            Font font, Icon icon, Graphics graphics)
        {
        ...
        public override Rectangle GetNextButtonBounds(Rectangle previousBounds, string text, Font font, Icon icon,
            Graphics graphics)
        {
        ...
        public override Rectangle GetButtonsClipRectangle(Rectangle panelBounds, bool hasScroll,
            int captionButtonsCount)
        {
            int dY = 4 + PanelMargin;
            ...
            return new Rectangle(panelBounds.Left + ButtonLeftMargin, panelBounds.Top + dY, ButtonWidth + 1,
                panelBounds.Bottom - 2 * dY - PanelMargin - dh);
        }
        ...
        public override Rectangle GetCaptionButtonsRectangle(Rectangle panelBounds, int captionButtonsCount)
        {
            ...
            return new Rectangle(panelBounds.Left + ButtonLeftMargin, panelBounds.Bottom - height - 2 * PanelMargin,
                width, height);
        }
        ...
        internal override bool CanUndoDisplaceNext(UnitButton displacedButton, UnitButton selectedButton,
            Point mouseLocation)
        {
            return true;
        }
        ...
        /// <param name="mouseLocation">current mouse location</param>
        /// <returns>true if can undo</returns>
        internal override bool CanUndoDisplaceBack(UnitButton displacedButton, UnitButton selectedButton,
            Point mouseLocation)
        {
