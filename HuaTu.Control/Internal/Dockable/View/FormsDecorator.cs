...
using HuaTu.Controls.Internal.Dockable.Enum;
using System;
...
namespace HuaTu.Controls.Internal.Dockable.View
{
    ...
    /// </summary>
    public partial class FormsDecorator : Control
    {
        #region Fields
        ...
        private ModeSize _sizeMode = ModeSize.None;
