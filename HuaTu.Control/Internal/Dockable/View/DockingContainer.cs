...
namespace HuaTu.Controls.Internal.Dockable.View
{
    ...
    /// </summary>
    public partial class DockingContainer : Control
    {
        #region Fields
        ...
        /// </summary>
        public DockingContainer LeftPane
        {
            get { return (DockingContainer)InternalControls.LeftPane; }
        }

        /// <summary>
        /// Accessor of the right pane
        /// </summary>
        public DockingContainer RightPane
        {
            get { return (DockingContainer)InternalControls.RightPane; }
        }

        /// <summary>
        /// Accessor of the top pane
        /// </summary>
        public DockingContainer TopPane
        {
            get { return (DockingContainer)InternalControls.TopPane; }
        }

        /// <summary>
        /// Accessor of the bottom pane
        /// </summary>
        public DockingContainer BottomPane
        {
            get { return (DockingContainer)InternalControls.BottomPane; }
        }
        ...
        public DockingContainer OtherPane(DockingContainer view)
        {
            if (view == LeftPane)
            {
                return RightPane;
