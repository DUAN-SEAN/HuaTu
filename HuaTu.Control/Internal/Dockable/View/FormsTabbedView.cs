...
namespace HuaTu.Controls.Internal.Dockable.View
{
    ...
    /// Tabed host control
    /// </summary>
    public partial class FormsTabbedView : ButtonContainer
    {
        #region Fields
        ...
        private DockableMode _dockMode = DockableMode.Inner;
        ...
        private UnitButton _movedButton = null;
        ...
        /// </summary>
        public DockableMode CurrentDockMode
        {
        ...
        {
            UnitButton button = GetButton((Form)sender);
            RemoveButton(button);
        }
        ...
        private void InitializeComponent()
        {
            ...
            // FormsTabbedView
            // 
            this.Name = "FormsTabbedView";
            this.Load += new System.EventHandler(this.FormsTabbedView_Load);
            this.ResumeLayout(false);

        }

        private void FormsTabbedView_Load(object sender, EventArgs e)
        {
