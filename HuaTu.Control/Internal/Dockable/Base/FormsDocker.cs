...
namespace HuaTu.Controls.Internal.Dockable.Base
{
    ...
    /// Forms docker
    /// </summary>
    internal class FormsDocker : DisposablePage
    {
        #region 字段
        ...
        private void SortContainersBasedOnTheirZOrder(List<DockingContainer> containers)
        {
            Comparison<DockingContainer> containersSorterHandler = delegate (DockingContainer container1, DockingContainer container2)
            {
