...
using HuaTu.Controls.Internal.Dockable.View.Controls;
...
namespace HuaTu.Controls.Internal.Dockable.Base
{
    ...
    /// </summary>
    internal sealed class CenterDockButtons : DisposablePage
    {
        #region Fields
        ...
        private DockAllowed _lastAllowedDockMode = DockAllowed.None;
