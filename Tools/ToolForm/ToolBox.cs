...
namespace HuaTuDemo.Tools.ToolForm
{
    public partial class ToolBox : Form
    {
        ...
        public void SetToolSelection(DrawArea.DrawToolType tool)
        {
            switch (tool)
            {
                case DrawArea.DrawToolType.Pointer:
                    radioButton_Pointer.Checked = true;
                    break;
                case DrawArea.DrawToolType.Ellipse:
                    radioButton_ellipse.Checked = true;
                    break;
                case DrawArea.DrawToolType.Rectangle:
                    radioButton_rectangle.Checked = true;
                    break;
                case DrawArea.DrawToolType.Line:
                    radioButton_line.Checked = true;
                    break;
                case DrawArea.DrawToolType.Pan:
